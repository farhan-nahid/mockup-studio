...
export const SidebarControls: React.FC<SidebarProps> = ({ config, onChangeConfig }) => {
  ...
  return (
    <aside className="w-full lg:w-80 h-full bg-[#12141d]/95 backdrop-blur-xl border-l border-white/10 flex flex-col z-30 select-none">
      {/* Sidebar Tabs */}
      <div className="flex items-center justify-around border-b border-white/10 p-2 bg-black/20">
        <button
          type="button"
      ...
      {/* Tab Contents */}
      <div className="flex-1 overflow-y-auto p-4 space-y-6 text-gray-300 custom-scrollbar">
        {/* ================= BROWSER TAB ================= */}
        {activeTab === 'browser' && (
