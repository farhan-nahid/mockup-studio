...
export const EXPORT_SIZE_PRESETS: import('../types').ExportSizePreset[] = [
  ...
  },
  {
    ...
    label: '2560 × 1440 HD',
    scale: 2,
    description: 'Crisp HD resolution. Ideal for presentations, portfolios & social media.',
  },
  {
    id: '4k',
    name: '4K Ultra HD (3x)',
...
export const QUICK_PRESETS: { name: string; iconName: string; config: Partial<MockupConfig> }[] = [
  {
